...
{
public:
	UDP_Channel_t(uint8_t* SRC_IP, uint16_t SRC_PORT, uint8_t* DST_IP, uint16_t DST_PORT, struct netif* Netif_ptr);
	UDP_Channel_t(uint16_t SRC_PORT, uint8_t* DST_IP, uint16_t DST_PORT, struct netif* Netif_ptr);
...
private:
	void Constructor(uint8_t* SRC_IP, uint16_t SRC_PORT, uint8_t* DST_IP, uint16_t DST_PORT, struct netif* Netif_ptr);
